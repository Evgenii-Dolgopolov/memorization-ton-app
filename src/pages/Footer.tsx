      ...
      <div className="h-full flex m-auto justify-around">
        <button
          ...
          className={`w-full border-2 border-none ${
            currentTab === "Learn" ? "bg-blue-400 text-white shadow-2xl" : ""
          }`}>
          <i className="fa-solid fa-brain fa-3x"></i>
        </button>
        <button
          id="DeckTabButton"
          onClick={() => handleTabChange("DeckTab")}
          className={`w-full border-2 border-none ${
            currentTab === "DeckTab" ? "bg-blue-400 text-white shadow-2xl" : ""
          }`}>
        ...
        <button
          ...
          className={`w-full border-2 border-none ${
            currentTab === "Settings" ? "bg-blue-400 text-white shadow-2xl" : ""
          }`}>
